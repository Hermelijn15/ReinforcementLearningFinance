...
def step(nn, history, epsilon, risk_free_rate, n_actions, features, max_allocation=1):
    ...
    #add some noise to states
    #print(states.head())
    states = utils.add_noise(states, 0.01)
    #print(states.head())
...
if __name__ == "__main__":
    ...
    SP500(risk_free_rate=0, gamma =0.90, batch_size=batch_size , learning_rate = learning_rate , folder = "SP500_noise",  features=features )
