...
def step(nn, history, epsilon, risk_free_rate, n_actions, features, max_allocation=1):
    ...
    #equivalent to reward = rewards.percentage_reward(price_change, allocation, risk_free_rate = risk_free_rate)
...
if __name__ == "__main__":
    ...
    reverting(size=20000, risk_free_rate=0.0001, mean=0.015, std=2.5, gamma =0.90, batch_size=batch_size , learning_rate = learning_rate , folder = "results_reverting",  features=features )
